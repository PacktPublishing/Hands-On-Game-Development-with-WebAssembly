...
// refer to Module (if they choose; they can also define Module)
  ...
  Module['FS_createPath']('/', 'sprites', true, true);
   ...
   loadPackage({"files": [{"filename": "/sprites/BirdOfAnger.png", "start": 0, "end": 375, "audio": 0}, {"filename": "/sprites/BirdOfAngerExp.png", "start": 375, "end": 2556, "audio": 0}, {"filename": "/sprites/Franchise.png", "start": 2556, "end": 5711, "audio": 0}, {"filename": "/sprites/Franchise1.png", "start": 5711, "end": 8866, "audio": 0}, {"filename": "/sprites/Franchise2.png", "start": 8866, "end": 12041, "audio": 0}, {"filename": "/sprites/Franchise3.png", "start": 12041, "end": 15215, "audio": 0}, {"filename": "/sprites/Franchise4.png", "start": 15215, "end": 18378, "audio": 0}, {"filename": "/sprites/FranchiseExp.png", "start": 18378, "end": 23489, "audio": 0}, {"filename": "/sprites/FranchiseExplosion1.png", "start": 23489, "end": 23871, "audio": 0}, {"filename": "/sprites/FranchiseExplosion2.png", "start": 23871, "end": 24371, "audio": 0}, {"filename": "/sprites/FranchiseExplosion3.png", "start": 24371, "end": 24984, "audio": 0}, {"filename": "/sprites/FranchiseExplosion4.png", "start": 24984, "end": 25608, "audio": 0}, {"filename": "/sprites/FranchiseExplosion5.png", "start": 25608, "end": 26116, "audio": 0}, {"filename": "/sprites/FranchiseExplosion6.png", "start": 26116, "end": 26434, "audio": 0}, {"filename": "/sprites/FranchiseExplosion7.png", "start": 26434, "end": 26589, "audio": 0}, {"filename": "/sprites/FranchiseExplosion8.png", "start": 26589, "end": 26711, "audio": 0}, {"filename": "/sprites/Projectile.png", "start": 26711, "end": 26857, "audio": 0}, {"filename": "/sprites/ProjectileExp.png", "start": 26857, "end": 28545, "audio": 0}], "remote_package_size": 28545, "package_uuid": "f5162303-c53d-482e-b531-8cebc80e6dba"});
...
var wasmBinaryFile = 'collider.wasm';
...
var ASM_CONSTS = {
  55852: function($0, $1, $2) {var w = $0; var h = $1; var pixels = $2; if (!Module['SDL2']) Module['SDL2'] = {}; var SDL2 = Module['SDL2']; if (SDL2.ctxCanvas !== Module['canvas']) { SDL2.ctx = Module['createContext'](Module['canvas'], false, true); SDL2.ctxCanvas = Module['canvas']; } if (SDL2.w !== w || SDL2.h !== h || SDL2.imageCtx !== SDL2.ctx) { SDL2.image = SDL2.ctx.createImageData(w, h); SDL2.w = w; SDL2.h = h; SDL2.imageCtx = SDL2.ctx; } var data = SDL2.image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = 0xff; src++; dst += 4; } } else { if (SDL2.data32Data !== data) { SDL2.data32 = new Int32Array(data.buffer); SDL2.data8 = new Uint8Array(data.buffer); } var data32 = SDL2.data32; num = data32.length; data32.set(HEAP32.subarray(src, src + num)); var data8 = SDL2.data8; var i = 3; var j = i + 4*num; if (num % 8 == 0) { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; } } else { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; } } } SDL2.ctx.putImageData(SDL2.image, 0, 0); return 0;},  
 57331: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 58320: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 58413: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 59638: function() {return screen.width;},  
 59665: function() {return screen.height;},  
 59693: function() {return window.innerWidth;},  
 59725: function() {return window.innerHeight;},  
 59803: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 59937: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 60103: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
 60329: function($0) {if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { autoResumeAudioContext(SDL2.audioContext); } } return SDL2.audioContext === undefined ? -1 : 0;},  
 60882: function() {var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate;},  
