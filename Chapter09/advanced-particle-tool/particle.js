...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5322832,
    DYNAMIC_BASE = 5322832,
    DYNAMICTOP_PTR = 79696;
...
function integrateWasmJS() {
  var wasmBinaryFile = 'particle.wasm';
...
var STATIC_BUMP = 78928;
Module["STATIC_BASE"] = STATIC_BASE;
Module["STATIC_BUMP"] = STATIC_BUMP;

/* no memory initializer */
var tempDoublePtr = 79936
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=79744;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
...
Module['wasmTableSize'] = 62208;

Module['wasmMaxTableSize'] = 62208;
...
var real__add_emitter = asm["_add_emitter"]; asm["_add_emitter"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__add_emitter.apply(null, arguments);
};
...
var real__update_emitter = asm["_update_emitter"]; asm["_update_emitter"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__update_emitter.apply(null, arguments);
};
...
var _add_emitter = Module["_add_emitter"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_add_emitter"].apply(null, arguments) };
...
var _update_emitter = Module["_update_emitter"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_update_emitter"].apply(null, arguments) };
