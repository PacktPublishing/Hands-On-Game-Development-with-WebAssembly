...
// refer to Module (if they choose; they can also define Module)
  ...
  Module['FS_createPath']('/', 'sprites', true, true);
   ...
   loadPackage({"files": [{"filename": "/sprites/asteroid.png", "start": 0, "end": 482, "audio": 0}, {"filename": "/sprites/BirdOfAnger.png", "start": 482, "end": 857, "audio": 0}, {"filename": "/sprites/BirdOfAngerExp.png", "start": 857, "end": 3038, "audio": 0}, {"filename": "/sprites/Explode.png", "start": 3038, "end": 4003, "audio": 0}, {"filename": "/sprites/flare.png", "start": 4003, "end": 7292, "audio": 0}, {"filename": "/sprites/Franchise.png", "start": 7292, "end": 10447, "audio": 0}, {"filename": "/sprites/Franchise1.png", "start": 10447, "end": 13602, "audio": 0}, {"filename": "/sprites/Franchise2.png", "start": 13602, "end": 16777, "audio": 0}, {"filename": "/sprites/Franchise3.png", "start": 16777, "end": 19951, "audio": 0}, {"filename": "/sprites/Franchise4.png", "start": 19951, "end": 23114, "audio": 0}, {"filename": "/sprites/FranchiseExp.png", "start": 23114, "end": 28225, "audio": 0}, {"filename": "/sprites/FranchiseExplosion1.png", "start": 28225, "end": 28607, "audio": 0}, {"filename": "/sprites/FranchiseExplosion2.png", "start": 28607, "end": 29107, "audio": 0}, {"filename": "/sprites/FranchiseExplosion3.png", "start": 29107, "end": 29720, "audio": 0}, {"filename": "/sprites/FranchiseExplosion4.png", "start": 29720, "end": 30344, "audio": 0}, {"filename": "/sprites/FranchiseExplosion5.png", "start": 30344, "end": 30852, "audio": 0}, {"filename": "/sprites/FranchiseExplosion6.png", "start": 30852, "end": 31170, "audio": 0}, {"filename": "/sprites/FranchiseExplosion7.png", "start": 31170, "end": 31325, "audio": 0}, {"filename": "/sprites/FranchiseExplosion8.png", "start": 31325, "end": 31447, "audio": 0}, {"filename": "/sprites/ParticleBright.png", "start": 31447, "end": 33948, "audio": 0}, {"filename": "/sprites/ParticleDark.png", "start": 33948, "end": 36589, "audio": 0}, {"filename": "/sprites/Projectile.png", "start": 36589, "end": 36735, "audio": 0}, {"filename": "/sprites/ProjectileExp.png", "start": 36735, "end": 38423, "audio": 0}, {"filename": "/sprites/ProjectileExpOrange.png", "start": 38423, "end": 41568, "audio": 0}, {"filename": "/sprites/rotating-star.png", "start": 41568, "end": 54318, "audio": 0}, {"filename": "/sprites/shield-bird.png", "start": 54318, "end": 55165, "audio": 0}, {"filename": "/sprites/shield-franchise.png", "start": 55165, "end": 58756, "audio": 0}, {"filename": "/sprites/small-asteroid.png", "start": 58756, "end": 61852, "audio": 0}], "remote_package_size": 61852, "package_uuid": "ec91cd30-0847-48ef-ae90-4ffd06caac08"});
...
var ASM_CONSTS = {
  38876: function($0, $1, $2) {var w = $0; var h = $1; var pixels = $2; if (!Module['SDL2']) Module['SDL2'] = {}; var SDL2 = Module['SDL2']; if (SDL2.ctxCanvas !== Module['canvas']) { SDL2.ctx = Module['createContext'](Module['canvas'], false, true); SDL2.ctxCanvas = Module['canvas']; } if (SDL2.w !== w || SDL2.h !== h || SDL2.imageCtx !== SDL2.ctx) { SDL2.image = SDL2.ctx.createImageData(w, h); SDL2.w = w; SDL2.h = h; SDL2.imageCtx = SDL2.ctx; } var data = SDL2.image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = 0xff; src++; dst += 4; } } else { if (SDL2.data32Data !== data) { SDL2.data32 = new Int32Array(data.buffer); SDL2.data8 = new Uint8Array(data.buffer); } var data32 = SDL2.data32; num = data32.length; data32.set(HEAP32.subarray(src, src + num)); var data8 = SDL2.data8; var i = 3; var j = i + 4*num; if (num % 8 == 0) { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; } } else { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; } } } SDL2.ctx.putImageData(SDL2.image, 0, 0); return 0;},  
 40355: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 41344: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 41437: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 42662: function() {return screen.width;},  
 42689: function() {return screen.height;},  
 42717: function() {return window.innerWidth;},  
 42749: function() {return window.innerHeight;},  
 42827: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 42961: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 43127: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
 43353: function($0) {if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { autoResumeAudioContext(SDL2.audioContext); } } return SDL2.audioContext === undefined ? -1 : 0;},  
 43906: function() {var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate;},  
 43976: function($0, $1, $2, $3) {var SDL2 = Module['SDL2']; var have_microphone = function(stream) { if (SDL2.capture.silenceTimer !== undefined) { clearTimeout(SDL2.capture.silenceTimer); SDL2.capture.silenceTimer = undefined; } SDL2.capture.mediaStreamNode = SDL2.audioContext.createMediaStreamSource(stream); SDL2.capture.scriptProcessorNode = SDL2.audioContext.createScriptProcessor($1, $0, 1); SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) { if ((SDL2 === undefined) || (SDL2.capture === undefined)) { return; } audioProcessingEvent.outputBuffer.getChannelData(0).fill(0.0); SDL2.capture.currentCaptureBuffer = audioProcessingEvent.inputBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.mediaStreamNode.connect(SDL2.capture.scriptProcessorNode); SDL2.capture.scriptProcessorNode.connect(SDL2.audioContext.destination); SDL2.capture.stream = stream; }; var no_microphone = function(error) { }; SDL2.capture.silenceBuffer = SDL2.audioContext.createBuffer($0, $1, SDL2.audioContext.sampleRate); SDL2.capture.silenceBuffer.getChannelData(0).fill(0.0); var silence_callback = function() { SDL2.capture.currentCaptureBuffer = SDL2.capture.silenceBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.silenceTimer = setTimeout(silence_callback, ($1 / SDL2.audioContext.sampleRate) * 1000); if ((navigator.mediaDevices !== undefined) && (navigator.mediaDevices.getUserMedia !== undefined)) { navigator.mediaDevices.getUserMedia({ audio: true, video: false }).then(have_microphone).catch(no_microphone); } else if (navigator.webkitGetUserMedia !== undefined) { navigator.webkitGetUserMedia({ audio: true, video: false }, have_microphone, no_microphone); }},  
 45628: function($0, $1, $2, $3) {var SDL2 = Module['SDL2']; SDL2.audio.scriptProcessorNode = SDL2.audioContext['createScriptProcessor']($1, 0, $0); SDL2.audio.scriptProcessorNode['onaudioprocess'] = function (e) { if ((SDL2 === undefined) || (SDL2.audio === undefined)) { return; } SDL2.audio.currentOutputBuffer = e['outputBuffer']; dynCall('vi', $2, [$3]); }; SDL2.audio.scriptProcessorNode['connect'](SDL2.audioContext['destination']);},  
 46038: function($0, $1) {var SDL2 = Module['SDL2']; var numChannels = SDL2.capture.currentCaptureBuffer.numberOfChannels; for (var c = 0; c < numChannels; ++c) { var channelData = SDL2.capture.currentCaptureBuffer.getChannelData(c); if (channelData.length != $1) { throw 'Web Audio capture buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } if (numChannels == 1) { for (var j = 0; j < $1; ++j) { setValue($0 + (j * 4), channelData[j], 'float'); } } else { for (var j = 0; j < $1; ++j) { setValue($0 + (((j * numChannels) + c) * 4), channelData[j], 'float'); } } }},  
