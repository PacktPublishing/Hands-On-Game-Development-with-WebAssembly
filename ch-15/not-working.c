...
const GLchar* fragment_shader_code[] = {
      ...
      "void main() {    \n"
//        "gl_FragColor = max(texture2D(u_glow, v_texcoord), texture2D(u_texture, v_texcoord));   \n"
//        "gl_FragColor = min(texture2D(u_glow, v_texcoord), texture2D(u_texture, v_texcoord));   \n"
