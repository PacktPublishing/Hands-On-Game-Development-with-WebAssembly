...
function integrateWasmJS() {
  var wasmBinaryFile = 'shell-closure.wasm';
...
var ASM_CONSTS = [function() { InitWrappers() }];
...
var real__float_test = asm["_float_test"]; asm["_float_test"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__float_test.apply(null, arguments);
};
...
var real__int_test = asm["_int_test"]; asm["_int_test"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__int_test.apply(null, arguments);
};
...
var real__string_test = asm["_string_test"]; asm["_string_test"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__string_test.apply(null, arguments);
};
